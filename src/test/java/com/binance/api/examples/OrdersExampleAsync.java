...
public class OrdersExampleAsync {
  ...
  public static void main(String[] args) {
    ...
    client.getAllOrders("API_KEY", "SECRET",new AllOrdersRequest("LINKETH").limit(10), response -> System.out.println(response));
    ...
    client.newOrderTest("API_KEY", "SECRET",limitBuy("LINKETH", TimeInForce.GTC, "1000", "0.0001"),
        response -> System.out.println("Test order has succeeded."));

    // Placing a test MARKET order
    client.newOrderTest("API_KEY", "SECRET", marketBuy("LINKETH", "1000"), response -> System.out.println("Test order has succeeded."));
