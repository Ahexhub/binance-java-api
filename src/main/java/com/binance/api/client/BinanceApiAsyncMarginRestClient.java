...
public interface BinanceApiAsyncMarginRestClient {
   ...
   */
  void getAccount(String apiKey, String secret, Long recvWindow, Long timestamp, BinanceApiCallback<MarginAccount> callback);

  /**
   * Get current margin account information using default parameters (async).
   */
  void getAccount(String apiKey, String secret, BinanceApiCallback<MarginAccount> callback);
   ...
   */
  void startUserDataStream(String apiKey, BinanceApiCallback<ListenKey> callback);
   ...
   */
  void keepAliveUserDataStream(String apiKey, String listenKey, BinanceApiCallback<Void> callback);
   ...
   */
  void transfer(String apiKey, String secret, String asset, String amount, TransferType type, BinanceApiCallback<MarginTransaction> callback);
   ...
   * @return transaction id
   */
  void borrow(String apiKey, String secret, String asset, String amount, BinanceApiCallback<MarginTransaction> callback);
   ...
   * @return transaction id
   */
  void repay(String apiKey, String secret, String asset, String amount, BinanceApiCallback<MarginTransaction> callback);
