...
public interface BinanceApiAsyncRestClient {
     ...
     * @param callback the callback that handles the response
     */
    void newOrder(String apiKey, String secret, NewOrder order, BinanceApiCallback<NewOrderResponse> callback);
     ...
     * @param callback the callback that handles the response.
     */
    void newOcoOrder(String apiKey, String secret, NewOrder order, BinanceApiCallback<OcoOrderResponse> callback);
     ...
     * @param callback the callback that handles the response
     */
    void newOrderTest(String apiKey, String secret, NewOrder order, BinanceApiCallback<Void> callback);
     ...
     * @param callback           the callback that handles the response
     */
    void cancelOcoOrder(String apiKey, String secret, CancelOrderRequest cancelOrderRequest, BinanceApiCallback<OcoOrderResponse> callback);
     ...
     * @param callback     the callback that handles the response
     */
    void getAllOrders(String apiKey, String secret, AllOrdersRequest orderRequest, BinanceApiCallback<List<Order>> callback);

    /**
     * Get current account information (async).
     */
    void getAccount(String apiKey, String secret, Long recvWindow, Long timestamp, BinanceApiCallback<Account> callback);

    /**
     * Get current account information using default parameters (async).
     */
    void getAccount(String apiKey, String secret, BinanceApiCallback<Account> callback);
     ...
     */
    void getMyTrades(String apiKey, String secret, String symbol, Integer limit, Long fromId, Long recvWindow, Long timestamp, BinanceApiCallback<List<Trade>> callback);
     ...
     * @param callback the callback that handles the response with a list of trades
     */
    void getMyTrades(String apiKey, String secret, String symbol, Integer limit, BinanceApiCallback<List<Trade>> callback);
     ...
     */
    void withdraw(String apiKey, String secret, String asset, String address, String amount, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback);
     ...
     */
    void getDepositHistory(String apiKey, String secret, String asset, BinanceApiCallback<DepositHistory> callback);
     ...
     */
    void getWithdrawHistory(String apiKey, String secret, String asset, BinanceApiCallback<WithdrawHistory> callback);
     ...
     */
    void getDepositAddress(String apiKey, String secret, String asset, BinanceApiCallback<DepositAddress> callback);
     ...
     */
    void startUserDataStream(String api, BinanceApiCallback<ListenKey> callback);
     ...
     * @param callback  the callback that handles the response which contains a listenKey
     */
    void keepAliveUserDataStream(String api, String listenKey, BinanceApiCallback<Void> callback);
     ...
     * @param callback  the callback that handles the response which contains a listenKey
     */
    void closeUserDataStream(String api, String listenKey, BinanceApiCallback<Void> callback);
     ...
     * @param callback the callback that handles the response
     */
    void convertDustToBnb(String apiKey, String secret, List<String> assets, BinanceApiCallback<DustTransferResponse> callback);
}