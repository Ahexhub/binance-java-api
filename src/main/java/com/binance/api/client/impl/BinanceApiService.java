...
public interface BinanceApiService {
    ...
    Call<NewOrderResponse> newOrder(@Query("symbol") String symbol, @Query("side") OrderSide side, @Query("type") OrderType type,
                                    ...
                                    @Header("api") String apiKey, @Header("Secret") String secret);
    ...
    Call<ListenKey> startUserDataStream(@Header("api") String api);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @PUT("/api/v1/userDataStream")
    Call<Void> keepAliveUserDataStream(@Query("listenKey") String listenKey, @Header("api") String api);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @DELETE("/api/v1/userDataStream")
    Call<Void> closeAliveUserDataStream(@Query("listenKey") String listenKey, @Header("api") String api);

    // Isolated Margin Account endpoints
    @Headers({BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER, BinanceApiConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER})
    @POST("/sapi/v1/margin/isolated/create")
    Call<NewIsolatedAccountResponse> createIsolatedMarginAccount(@Query("base") String base,
                                                                 @Query("quote") String quote,
                                                                 @Query("recvWindow") Long recvWindow,
                                                                 @Query("timestamp") Long timestamp,
                                                                 @Header("api") String api, @Header("secret") String secret);
    ...
    Call<ListenKey> startMarginUserDataStream(@Header("api") String api);

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @PUT("/sapi/v1/userDataStream")
    Call<Void> keepAliveMarginUserDataStream(@Query("listenKey") String listenKey, @Header("api") String api);
    // Binance Liquidity Swap Pool endpoints

    @Headers(BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    @GET("/sapi/v1/bswap/pools")
    Call<List<Pool>> listAllSwapPools(@Header("api") String api);
